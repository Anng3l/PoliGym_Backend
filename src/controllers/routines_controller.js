    ...
    if (datos.exercises)
    {
      for (const [index, ejercicio] of datos.exercises.entries()) {
        await check(`exercises[${index}].name`)
              ...
              .trim()
              .isString()
              .withMessage("El nombre del ejercicio debe ser un cadena de caracteres")
        ...
        await check(`exercises[${index}].repetitions`)
              ...
              .withMessage("Las repeticiones deben ser números positivos entre el 1 y el 3600")
              .run(req)
    ...
    if (datos.exercises)
    {
      for (const [index, ejercicio] of datos.exercises.entries()) {
        ...
        await check(`exercises[${index}].series`)
              ...
              .trim()
              .isInt({min: 1})
              .withMessage("Las serie debe ser un número entero positivos")
              .run(req)
        ...
        await check(`exercises[${index}].measure`)
              ...
              .trim()
              .isString()
              .withMessage("La unidad de medida debe ser una cadena de caracteres")
              .run(req)
      };
      const erroresEjercicios = validationResult(req);
      if (!erroresEjercicios.isEmpty()) {
    ...
    if (datos.exercises)
    {
      for (const [index, ejercicio] of datos.exercises.entries()) {
        ...
        await check(`exercises[${index}].series`)
              ...
              .trim()
              .isInt({min: 1})
              .withMessage("Las serie debe ser un número entero positivo")
              .run(req)
        ...
        await check(`exercises[${index}].repetitions`)
              ...
              .trim()
              .isFloat({min: 1, max: 3600})
              .withMessage("Las repeticiones deben ser números positivos entre 1 y 3600")
              .run(req)
    ...
    if (datos.exercises)
    {
      for (const [index, ejercicio] of datos.exercises.entries()) {
        ...
        await check(`exercises[${index}].series`)
              ...
              .trim()
              .isInt({min: 1})
              .withMessage("La serie debe ser un número entero positivo")
              .run(req)
